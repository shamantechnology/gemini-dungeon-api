...
class Player:
    def __init__(self,
        ...
        # setup inventory, give players starting equipment
        # generated by DND library
        self.inventory = []
        for inventory in self.dndc.inventory:
            self.inventory.append(inventory.name)

        if self.player_class == "Paladin":
            self.inventory.append("longsword")
        ...
        self.inventory.append("explorers-pack")
